...
const tampilKategori = async (req, res) => {
  try {
    ...
    if (allKategori.length > 0) {
      ...
      return res
        .status(400)
        .json({ success: false, message: "Data kategori tidak ditemukan" });
    }
  } catch (error) {
    console.log(error);
    return res
...
const tambahKategori = async (req, res) => {
  try {
    ...
    if (!nama_kategori || !slug) {
      return res
        .status(400)
        .json({ success: false, message: "Silahkan lengkapi data kategori" });
    }
    ...
    if (findKategori) {
      return res
        ...
        .json({
          success: false,
          message: "Data kategori sudah tersedia sebelumnay",
        });
    } else {
      ...
      return res
        .status(200)
        .json({ success: true, message: "Data kategori berhasil ditambahkan" });
    }
  } catch (error) {
    console.log(error);
    return res
...
const editKategori = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ success: true, message: "Data kategori berhasil diperbaharui" });
  } catch (error) {
    console.log(error);
    return res
      .status(500)
  ...
  try {
    ...
    if (!hapus) {
      return res
        ...
        .json({
          success: false,
          message: "Data kategori tidak berhasil dihapus",
        });
    }
    return res
      .status(200)
      .json({ success: true, message: "Data kategori berhasil dihapus" });
  } catch (error) {
    console.log(error);
    return res
      .status(500)
